the RequestAttribute listener listens for request attribute events . all three methods are defined in Listener class,but i have
...
the class ServletRequestAttributeEvent has methods public String getName() and public String getValue().